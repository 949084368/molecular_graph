...
if __name__ == '__main__':
    ...
    # v1 啥都要的缝合怪 加个进度条应该还行
    # python3 train.py --data_path Data/AHR.csv --dataset_type classification --save_path model_save --model_type v1 --log_path log --split_type ratio_random
    # python3 train.py --data_path Data/AHR.csv --dataset_type classification --save_path model_save --model_type FP_GNN --log_path log4_12 --split_type ratio_random
    training(args,log)